...
function InformacionUbicacion({ preguntasUbicacion, respuestaUbicacion }) {
    const preguntasConRespuestas = preguntasUbicacion.map(pregunta => {
        const respuesta = respuestaUbicacion.find(res => res.pregunta_id === pregunta.id);
        return {
            ...pregunta,
    ...
    return (
        <div className="p-6 bg-white shadow-lg rounded-lg border border-gray-200">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">Información de ubicación</h2>
